...
public class DiversifiedCheckerTest {
	...
	public void test5StocksOneHasTwoThousandNotDiversified(){
		...
		stock5.setTickerSymbol(dominosSymbol);
		stock5.setValue(thousandDollars);
		stock5.setSector(Sector.ENERGY);
	...
	@Test
	public void test5StocksTwoSameSectorNotDiversified(){
		List<Stock> stocks = new ArrayList<Stock>();
		Stock stock1 = new Stock();
		Stock stock2 = new Stock();
		Stock stock3 = new Stock();
	...
	public void test7SDiversified(){
		...
		stock6.setTickerSymbol(geSymbol);
		stock6.setValue(thousandDollars);
		stock6.setSector(Sector.UTILITIES);
		
		stock7.setTickerSymbol(globalstarSymbol);
		stock7.setValue(thousandDollars);
		stock7.setSector(Sector.TELECOMMUNICATION_SERVICES);
